...
use WP_Ultimo\Dependencies\League\Uri\Exceptions\FileinfoSupportMissing;
use WP_Ultimo\Dependencies\League\Uri\Exceptions\IdnaConversionFailed;
use WP_Ultimo\Dependencies\League\Uri\Exceptions\IdnSupportMissing;
use WP_Ultimo\Dependencies\League\Uri\Exceptions\SyntaxError;
use WP_Ultimo\Dependencies\League\Uri\Idna\Idna;
...
final class Uri implements UriInterface
{
     ...
     */
    public static function createFromBaseUri(Stringable|UriInterface|string $uri, Stringable|UriInterface|string $base_uri = null) : UriInterface
    {
    ...
    {
        return $this->uri ??= $this->getUriString($this->scheme, $this->authority, $this->path, $this->query, $this->fragment);
    }
    /**
     * {@inheritDoc}
     */
