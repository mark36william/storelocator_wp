...
use WP_Ultimo\Dependencies\League\Uri\Exceptions\TemplateCanNotBeExpanded;
...
final class Expression
{
    ...
    private function __construct(private string $operator, VarSpecifier ...$varSpecifiers)
    {
        ...
        $this->value = '{' . $operator . implode(',', array_map(static fn(VarSpecifier $varSpecifier): string => $varSpecifier->toString(), $varSpecifiers)) . '}';
    }
    /**
