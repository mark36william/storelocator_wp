        ...
        private function _find_caller_plugin_file( $is_init = false, $main_file = '' ) {
            ...
            if ( isset( $this->_storage->plugin_main_file ) ) {
                ...
                if ( ! empty( $plugin_main_file->path ) ) {
                    $absolute_path = apply_filters('fs_find_caller_plugin_file', $this->get_absolute_path( $plugin_main_file->path ), $this->get_slug(), $plugin_main_file->path);
                    if ( file_exists( $absolute_path ) ) {
                        $main_file_absolute_path = apply_filters('fs_find_caller_plugin_file', $this->get_absolute_path( $main_file ), $this->get_slug(), $main_file);
                        if ( $is_init && $absolute_path !== $main_file_absolute_path ) {
            ...
            if ( ! $is_init ) {
                ...
                if ( isset( $this->_storage->plugin_main_file ) &&
                    ...
                    $absolute_path = apply_filters('fs_find_caller_plugin_file', $absolute_path, $this->get_slug(), $this->_storage->plugin_main_file->prev_path);
                    if ( file_exists( $absolute_path ) ) {
                        return $absolute_path;
                    }
                }
            ...
            return apply_filters('fs_find_caller_plugin_file', $this->get_absolute_path( $main_file ), $this->get_slug(), $main_file);
        }
