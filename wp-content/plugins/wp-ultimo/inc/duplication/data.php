    ...
    class MUCD_Data {
        ...
        public static function db_copy_tables( $from_site_id, $to_site_id ) {
            ...
            foreach ($from_site_table as $table) {
                ...
                $table_base_name = substr( $table, $from_site_prefix_length );
        ...
        */
        ...
        public static function sql_error($sql_query, $sql_error) {
            wu_log_add('site-duplication-errors', sprintf('Got error "%s" while running: %s', $sql_error, $sql_query), \Psr\Log\LogLevel::ERROR);
        }
