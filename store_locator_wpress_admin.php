<?php
define('STORE_LOCATOR_WPRESS_ADMIN', 'store_locator_wpress_admin');

class Store_locator_wpress_admin extends WPress_framework_store_locator {
	...
	function Store_locator_wpress_admin() {
		...
		if(is_admin()) {
			...
			wp_enqueue_script( 'store_wpress_js', plugin_dir_url( __FILE__ ).'class/store_locator/include/js/script.js');			
		}
	}
	...
	function config_page_init() {
		if (function_exists('add_submenu_page')) {
			add_menu_page( 'Stores list', 'Stores list', 'manage_options', 'store-locator-wpress', array(__CLASS__, 'store_locator_list'), '', 7 );
		...
		<div class="metabox-holder">
			...
			if(isset($_POST['update'])) {
				...
				echo '<form id="add_store_form2" method="post">';
					...
					echo '<p><input class="widefat" type="text" name="name" value="'.$store[0]['name'].'" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
					...
					echo '<p><input class="widefat" type="text" name="logo" value="'.$store[0]['logo'].'" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
					
					echo '<p><label>URL <small>(should start with http://)</small></label></p>';
					echo '<p><input class="widefat" type="text" name="url" value="'.$store[0]['url'].'" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
	
					echo '<p><label>Description</label></p>';
					echo '<p><textarea class="widefat" type="text" name="description" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;">'.$store[0]['description'].'</textarea>';
					
					echo '<p><label>Telephone</label></p>';
					echo '<p><input class="widefat" name="tel" value="'.$store[0]['tel'].'" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
					
					echo '<p><label>Email</label></p>';
					echo '<p><input class="widefat" name="email" value="'.$store[0]['email'].'" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
		...
		<div class="metabox-holder">
			...
			if(isset($_POST['update'])) {
				...
				echo '<form id="add_store_form2" method="post" style="display:none;">';
					...
					echo '<p><label>Logo URL <small>(link to the store image)</small></label></p>';
					echo '<p><input class="widefat" type="text" name="logo" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
					...
					echo '<p><label>Telephone</label></p>';
					echo '<p><input class="widefat" name="tel" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
					
					echo '<p><label>Email</label></p>';
					echo '<p><input class="widefat" name="email" style="width:100%; font-family: \'Courier New\', Courier, mono; font-size: 1.4em;"></p>';
